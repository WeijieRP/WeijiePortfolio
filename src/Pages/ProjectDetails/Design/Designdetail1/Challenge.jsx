...
export default function ChallengeSection({
  ...
  summary ="Build your personal brand and use it to design a simple 4-page portfolio site. Make at least five original visuals, use AI tools properly, and share one social media post. Keep the style consistent and explain your design choices in an easy, clear way.",

  // Right figure (swap later)
  problemImage   = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=1800&auto=format&fit=crop",
  problemCaption = "Scope: brand system + 5 assets + AI proof + 4 pages + one social piece",
}) {
        ...
        <div className="ch-inner">
          ...
          <aside className="ch-right">
            <figure className="ch-figure" data-reveal="figure">
              <img src={problemImage} alt="Deliverables overview" className="ch-img" loading="lazy" />
