...
export default function ARImageCardDemo({
  ...
  return (
    <section className="arc-section" id={id} ref={rootRef}>
      ...
      {/* ---------- Video with Website/Browser Frame ---------- */}
      ...
      {showTips && (
        <div className="arc-modal" onClick={closeOnBackdrop(setShowTips)}>
          <div className="arc-modal-card arc-modal-scroll" onClick={(e)=>e.stopPropagation()}>
            ...
            <section className="arc-tip">
              <h4>Use clear visual features</h4>
              <p>High contrast, clear shapes, useful edges.</p>
            </section>
            <section className="arc-tip">
              <h4>Balanced detail</h4>
              <p>Not too noisy, not too plain. Avoid repeating patterns.</p>
            </section>
            <section className="arc-tip">
              <h4>Matte, high-res print</h4>
              <p>Matte paper avoids glare and keeps details sharp.</p>
            </section>
            <section className="arc-tip">
              <h4>Steady scan</h4>
              <p>Hold flat and fill camera frame for fast lock-on.</p>
            </section>
            <section className="arc-tip">
              <h4>Aim for 3★+</h4>
              <p>Edit image if rating drops — boost edges & contrast.</p>
            </section>
          </div>
        </div>
      )}
