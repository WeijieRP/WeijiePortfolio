...
export default function FinalCTA({
  ...
  tagline = "Log in and try it out and feel free to share ideas or improvements. I’d love to build this further with feedback.",
  ...
  return (
    <section ref={rootRef} className="fcta-stage" id={id} aria-label="Final call to action">
      ...
      <div className="fcta-content">
        {/* 👇 only the heading gets the galaxy style */}
        <h2 className="fcta-heading galaxy-title--soft fcta-snap">{heading}</h2>
